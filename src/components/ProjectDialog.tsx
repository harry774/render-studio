      ...
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto p-0">
        ...
        <div className="relative w-full h-[400px] md:h-[500px]">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8">
            <p className="text-xs uppercase tracking-wider text-muted-foreground-portfolio/70 mb-2">{project.category}</p>
            <h2 className="text-4xl md:text-5xl font-serif text-muted-foreground-portfolio">{project.title}</h2>
          </div>
        </div>
